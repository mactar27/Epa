...
import { ArrowRight, ChevronDown, Grid3X3, Heart, Menu, Play, Sparkles, Users, X } from 'lucide-react'
...
export default function Page() {
  ...
  return <main>
    ...
    <section id="histoire" className="section story reveal"><div className="story-image"><img src={collage} alt="Les bénévoles EPA auprès des communautés" /><div className="image-tag"><Users size={20} /><span>Des jeunes engagés<br /><b>pour un impact réel</b></span></div></div><div className="story-copy"><p className="eyebrow">Qui sommes-nous ?</p><h2>Plus qu'une association.<br /><em>Un mouvement.</em></h2><p>EPA — Ensemble Pour l'Avenir est une organisation humanitaire et apolitique créée en Mars 2024 by un ensemble de jeunes déterminés à apporter la force, du réconfort et des perspectives pour bâtir un avenir meilleur.</p><div className="values"><div><Heart /><b>Solidarité</b><span>Soutenir les plus démunis et les personnes en grande précarité.</span></div><div><Sparkles /><b>Dignité</b><span>Aider chacun à retrouver sa vie, sa vie autonome et sa place.</span></div><div><Users /><b>Avenir</b><span>Accompagner et valoriser la jeunesse pour qu'elle croie en son avenir.</span></div></div><Button href="#histoire">Découvrir notre histoire</Button></div></section>
